...
angular.module('app', ['app.translation', 'app.router', 'app.login', 'app.remote', 'app.icon', 'app.signin', 'app.header', 'app.alert', 'app.search', 'app.menu', 'app.proposal', 'app.home', 'app.profile'])
